...
public class Fahrt {
	...
	public Fahrt(String from, String to, int year, int month, int day, int costs, String aso,
	...
	public Fahrt(int ID,String from, String to, int year, int month, int day, int costs, String aso,
			String phone, String name, String email, int hour, int minute) {
		super();
		this.ID = ID;
		this.date = date_format.format(new Date(year-1900, month-1, day));
